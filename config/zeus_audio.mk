...
ALARM_PATH := vendor/zeus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/zeus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/zeus/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/zeus/prebuilt/common/media/audio/ui
